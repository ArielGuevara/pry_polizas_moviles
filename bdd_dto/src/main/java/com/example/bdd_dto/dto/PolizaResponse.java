...
public class PolizaResponse {
    ...
    public PolizaResponse(String propietario, String modeloAuto, double valorSeguroAuto, String edadPropietario, int accidentes, double costoTotal) {
    ...
    public String getEdadPropietario() { return edadPropietario; }
